...
<body>
    ...
    <div class="topNav">
        ...
        <a href="#" class="four_1 a2"><img src="/depot/images/index02.png"><p>设 置</p></a>
        <a href="#" class="four_1 a3"><img src="/depot/images/index03.png"><p>车场信息</p></a>
        <a href="#" class="four_1 a4"><img src="/depot/images/index04.png"><p>收费记录</p></a>
        <div class="clear"></div>
