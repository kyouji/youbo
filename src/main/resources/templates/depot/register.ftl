...
<body>
    ...
    <!--注册开始-->
        <div class="mian">
            <form action="/depot/reg/save" method="post" id="regist_form">
                <div class="logintext">         
                    <input name="username" id="username" type="text" datatype="m" ajaxurl="/depot/reg/check/username" nullmsg="请输入手机号码！" errormsg="请输入一个正确的手机号码！" class="logintext01" placeholder="手机号" />
                ...
                <div class="logintext">         
                    <input id="password" datatype="*" recheck="password" nullmsg="请再次输入密码！" errormsg="两次输入的密码不一致！" type="password" class="logintext01" placeholder="重复密码" />
                    <span class="Validform_checktip Validform_wrong"></span>
                </div>
                <div class="logintext logintext_y">
                    <input name="code" id="code" type="text" datatype="*" ajaxurl="/depot/reg/check/yzm" nullmsg="请输入验证码！" errormsg="验证码错误！" class="logintext02" placeholder="输入验证码" />
                    <span class="Validform_checktip Validform_wrong"></span>
                </div>
