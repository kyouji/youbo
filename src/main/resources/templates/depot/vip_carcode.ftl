        ...
        <#if vip_list??>
            <#list vip_list as item>
            	<dl>
            		...
            		<dd>
            			<span>开始时间:</span>
            			<div><#if item.beginDate??>${item.beginDate?string("yyyy-MM-dd HH:mm:ss")}</#if></div>
            		</dd>
            		<dd>
            			<span>结束时间:</span>
            			<div><#if item.finishDate??>${item.finishDate?string("yyyy-MM-dd HH:mm:ss")}</#if></div>
            		</dd>
            	</dl>
        	</#list>
    	</#if>
