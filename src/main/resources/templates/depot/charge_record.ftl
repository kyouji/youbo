...
<body>
    ...
    <div class="pay_record">
        <div class="select_dates">
            <p class="select_1">选择日期查询</p>
            <a href="#" class="pre_1"></a>
        </div>
        <div class="payment_situation">
            <a href="#" class="a1 sel">未缴费</a>
            <a href="#" class="a1">手机缴费</a>
            <a href="#" class="a1">现金</a>
        </div>
    ...
    <a class="a3 sel" href="/depot/charge">收费记录<span></span></a>
