...
<body style="background: white;">
    ...
    <div class="rich02">
        <dl>
            <dd>
                <span>总金额 : </span>
                <div>￥<#if user??&&user.balance??>${user.balance?string("0.00")}<#else>0.00</#if></div>
            </dd>
            <dd>
                <span>银行卡: </span>
            ...
            <dd>
                <span>金额 : </span>
                <input type="text" name="cardMoney" id="cardMoney" value="<#if income??>${income?string("0.00")}<#else>0.00</#if>" />
            </dd>
            <dd>
                <div>
